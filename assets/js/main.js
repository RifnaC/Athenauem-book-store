(function ($) {
  ...
  $("#selectedAddress").click(function () {
    const button = document.getElementById('selectedAddress');
    const addressDataString = button.getAttribute('data-address');
    ...
    $('#savedId').text(addressData._id);
    $('#savedName').text(addressData.fullName);
    $('#savedPhone').text(addressData.phone);
    $('#savedAddress').text(addressData.address);
    $('#savedCity').text(addressData.city);
    $('#savedDistrict').text(addressData.district);
    $('#savedState').text(addressData.state);
    $('#savedPin').text(-addressData.pincode);
  });
